...
const SkillManager = () => {
    ...
    const fetchSkills = async () => {
        try {
            ...
            // Có thể sort data.data hoặc data tùy vào format backend trả về
            // Giả sử API trả về mảng trực tiếp hoặc object chứa mảng
    ...
    return (
        <div>
            ...
            <div className="flex flex-col md:flex-row justify-between md:items-center gap-4 mb-6">
                <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white transition-colors duration-300">Quản lý Kỹ năng</h2>
            ...
            <div className="hidden md:block bg-white/40 dark:bg-gray-900/40 backdrop-blur-xl rounded-3xl border border-white/50 dark:border-gray-800/50 shadow-2xl overflow-hidden transition-colors duration-300">
                <table className="w-full text-left text-gray-900 dark:text-white">
                    ...
                    <tbody className="divide-y divide-gray-200 dark:divide-gray-700 transition-colors duration-300">
                        {isLoading ? (
                            <tr><td colSpan="5" className="p-8 text-center text-gray-500 dark:text-gray-400">Đang tải dữ liệu...</td></tr>
                        ) : skills.length === 0 ? (
